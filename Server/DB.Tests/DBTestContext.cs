    ...
    public class DBTestContext : MinitwitContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                new User { ID = 1, username = "user1", email = "user1@test.com", pwd = "hash" },
                new User { ID = 2, username = "user2", email = "user2@test.com", pwd = "hash" },
                new User { ID = 3, username = "user3", email = "user3@test.com", pwd = "hash" },
                new User { ID = 4, username = "user4", email = "user4@test.com", pwd = "hash" }
            );
